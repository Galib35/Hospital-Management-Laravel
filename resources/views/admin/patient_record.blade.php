...
<!-- ...rest of your HTML code... -->
            ...
            <h2 class="centered-heading" >PREVIOUS PATIENT INFO </h2>
      ...
      <div class="table_container">
        ...
        <table class="table">
          <thead>
            <tr style="background-color: #a64d79; text-align:center">
              <th>ID</th>
              <th>Name</th>
              <th>Phone</th>
              <th>Email</th>
...
@if ($col%2==1)
    <tr style="background-color: #c7e3f0; text-align: center;">
      <td>{{ $record->id }}</td>
      <td>{{ $record->patient_name }}</td>
      <td>{{ $record->number }}</td>
      <td>{{ $record->email }}</td>
      <td>{{ $record->gender }}</td>
      <td>{{ $record->doctor_to }}</td>
      <td>{{ $record->specialist }}</td>
      <td>{{ $record->date }}</td>
    </tr>

@else
<tr style="background-color: #c9d1d5; text-align: center;">
  <td>{{ $record->id }}</td>
  <td>{{ $record->patient_name }}</td>
  <td>{{ $record->number }}</td>
  <td>{{ $record->email }}</td>
